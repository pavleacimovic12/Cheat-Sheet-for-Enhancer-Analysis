            ...
            if missing_enhancers:
                ...
                for enhancer_id in missing_enhancers:
                    ...
                    missing_data.append({
                        ...
                        'start': enhancer_peaks['start'].iloc[0] if not enhancer_peaks.empty else 0,
                        'end': enhancer_peaks['end'].iloc[0] if not enhancer_peaks.empty else 0,
                        'cargo': 'Unknown',
                        'experiment': 'Unknown',
            ...
            for enhancer_id in hof_enhancer_ids:
                ...
                if not enhancer_peaks.empty:
                    enhancer_info.append({
                        ...
                        'start': enhancer_peaks['start'].iloc[0],
                        'end': enhancer_peaks['end'].iloc[0],
                        'is_hof': True,
                        'cargo': 'Unknown',
                        'experiment': 'Unknown',
                        'proximal_gene': 'Unknown',
